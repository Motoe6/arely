...
export default defineConfig({
  resolve: {
    alias: {
      ...
      "@opencode/flow-sdk": fileURLToPath(new URL("./packages/flow-sdk/src", import.meta.url)),
      "@opencode/flow-ai-compiler": fileURLToPath(new URL("./packages/flow-ai-compiler/src", import.meta.url)),
    },
  },
  test: {
    globals: true,
