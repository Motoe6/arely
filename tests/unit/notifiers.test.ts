...
import { LogNotifier } from "@arelyos/engine/agents/notifiers/log-notifier.js";
import { WebhookNotifier } from "@arelyos/engine/agents/notifiers/webhook-notifier.js";
import { CompositeNotifier, createNotifiers } from "@arelyos/engine/agents/notifiers/notifier.js";
...
describe("LogNotifier", () => {
  ...
  it("logs alert info", async () => {
    const logger = await import("@arelyos/engine/logger.js");
