...
import { getTrace, listTraces, countTraces } from "@arelyos/engine/persistence/policy-audit-store.js";
...
function setupScale(n: number, tmpDir: string): { traceIds: string[]; engine: SimulationEngine; analyzer: ImpactAnalyzer; deadRec: import("@arelyos/engine/agents/policy/policy-recommender.js").PolicyRecommendation | undefined; recs: import("@arelyos/engine/agents/policy/policy-recommender.js").PolicyRecommendation[] } {
