...
import { getTrace, listTraces, countTraces } from "@arely/engine/persistence/policy-audit-store.js";
...
function setupScale(n: number, tmpDir: string): { traceIds: string[]; engine: SimulationEngine; analyzer: ImpactAnalyzer; deadRec: import("@arely/engine/agents/policy/policy-recommender.js").PolicyRecommendation | undefined; recs: import("@arely/engine/agents/policy/policy-recommender.js").PolicyRecommendation[] } {
